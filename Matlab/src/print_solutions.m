...
for i=1:size(result,1)
    n(i) = norm(mod(eval(subs(mod(eqs,prime),[x,y,z],result(i,:))),prime));
    ...
    fprintf(result_str,i,result(i,:),n(i),mod(eval(subs(mod(eqs,prime),[x,y,z],result(i,:))),prime),line_break);
end
end