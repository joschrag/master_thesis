...
if size(c,2)==10
    ...
    B = -[c(:,1),c(:,3),c(:,5),c(:,7),c(:,10)*y+c(:,16)];
    C = -[c(:,1),c(:,2),c(:,4),c(:,6),c(:,10)*z+c(:,16)];
    min_num_rows=5;
    i =   [6,12,7,13,4,14,18,5,15,19,1,11,17;...
        4,11,9,13,6,14,17,8,16,19,2,12,18;...
        5,11,8,12,7,15,17,9,16,19,3,13,18];
end
Q_list = {A,B,C};
