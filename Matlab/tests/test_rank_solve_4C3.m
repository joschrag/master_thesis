classdef test_rank_solve_4C3 < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_r1234(testCase)
            ...
            for i=1:testCase.testParameter.num_runs
                ...
                [u,v] = rank4_4C3_1234(r);
                if ~isempty(u)
                    for vec = [u,v]'
                        res = M*[vec(1)^2;vec(1)*vec(2);vec(2)^2;vec(1);vec(2);1];
                        if any(res)
                            disp(res)
                            disp(r)
                            disp(M)
